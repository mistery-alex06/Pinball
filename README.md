...
Quick Start
Clona la repo e lancia il flipper per testare le tue performance sul campo:

```bash
git clone [https://github.com/mistery-alex06/pinball.git](https://github.com/mistery-alex06/pinball.git)
cd pinball
